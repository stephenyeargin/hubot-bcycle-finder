...
/* global describe beforeEach context afterEach it */
...
const helper = new Helper('../src/bcycle-finder.js');
...
describe('hubot-bcycle-finder', () => {
  ...
  context('default stations tests', () => {
    ...
    it('returns the status of the default stations', function (done) {
  ...
  context('regular tests', () => {
    ...
    it('returns error message if no default stations set', function (done) {
      const selfRoom = this.room;
      selfRoom.user.say('alice', '@hubot bcycle');
    ...
    // hubot bcycle list
    it('gets a listing of stations in the city', function (done) {
      const selfRoom = this.room;
    ...
    it('returns the status for a given station', function (done) {
      const selfRoom = this.room;
    ...
    it('searches the listing of stations', function (done) {
      const selfRoom = this.room;
    ...
    // hubot bcycle info
    it('returns information about your program', function (done) {
      const selfRoom = this.room;
    ...
    // hubot bcycle price
    it('returns pricing plan information', function (done) {
      const selfRoom = this.room;
